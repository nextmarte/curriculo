...
```{r}
if(params$pdf_mode){
  cat("Veja meu currículo online _https://github.com/nextmarte/Marcus_Ramalho_CV.github.io/_")
} else {
  cat("[<i class='fas fa-download'></i> Baixar versão PDF](https://github.com/nextmarte/curriculo/raw/master/Marcus_Ramalho_strayer_cv.pdf)")
}
```
